...
public class FXMLAnchorPaneCadastroClientesController implements Initializable {
    ...
    public void handleButtonInserir() throws IOException {
        ...
        boolean buttonConfirmarClicked = showFXMLAnchorPaneCadastroClientesDialog(cliente);
    ...
    private boolean showFXMLAnchorPaneCadastroClientesDialog(Cliente cliente) throws IOException {
